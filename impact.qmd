...
If you absolutely must use Excel to store data, the only acceptable format is a rectangular, flat file. This is typically saved as a .csv.  What do we mean by this?
...
3.  Add the relevant metadata information in the forms (because this is a test archive, not all will be entered).  The forms will be slightly different from your metadata, but enter the relevant information for the appropriate form.
