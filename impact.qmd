...
Making an [untidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/untidy.xlsx) dataset [tidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/tidy.xlsx) using Excel. 

<h3>`r fa('chalkboard-user')` Watch and learn</h3>

Making an [untidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/untidy.xlsx) dataset [tidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/tidy.xlsx) using R.
...
Now try it on your own. Download the [untidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/untidy.xlsx) dataset and make it tidy using your preferred software. 
...
Create a data dictionary for the [tidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/tidy.xlsx) dataset from the previous example. 
...
Create a metadata file for the [tidy](https://github.com/tbep-tech/tbep-os-workshop/raw/master/data/tidy.xlsx) dataset from the previous example. Just start by using your data dictionary and develop narrative answers for "who", "what", "when", "where", "why", and "how" to describe your dataset.  Get creative with your descriptions since this is a made up dataset. 
