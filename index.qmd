...
1. ORCID create account: [link](https://orcid.org/){target="_blank"}

## Agenda

1.  [The basics of open science](#basics): 9am - 10am
2.  [Open science for collaboration](#collaborate): 10am - 12pm
3.  [Open science for impactful products](#impact): 12:30pm - 2:30pm
4.  [Lowering barriers to inclusion and addressing key critiques](#implement): 2:30pm - 3pm
...
<a href="https://github.com/tbep-tech/tbep-os-workshop/actions"><img src="https://github.com/tbep-tech/tbep-os-workshop/workflows/build/badge.svg" alt="build"/></a> This version of the website was built automatically with [GitHub Actions](https://github.com/tbep-tech/tbep-os-workshop/actions) on `r Sys.Date()`.
