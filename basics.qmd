...
Key words from this definition are italicized.  There are very specific tools in the open science toolbox that speak to each of these key words.  We'll cover some of these later. 
...
These are of course only conceptual boxes and there's considerable overlap across all schools when open science is used in practice.  For our purposes, we'll mostly be talking about ideas and tools from the pragmatic, infrastructure, and democratic schools of the thought.  The end goal is to provide you with the means to create more efficient and impactful science that can more readily be used by others in a collaborative setting.  
